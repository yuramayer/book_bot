...
from handlers import start_router, cancel_router, new_page_router, \
    change_book_router, choice_router, read_page_router, left_router, \
...
async def main():
    ...
    dp.include_routers(start_router, cancel_router, new_page_router,
                       change_book_router, choice_router, read_page_router,
                       left_router, right_router, translation_router,
                       dummy_router)
